...
export const MAXIMUM_SEC_EVIDENCE_AGE_DAYS = 7;
...
export const RATING_COMPONENT_SPECIFICATIONS: readonly RatingComponentSpecification[] =
  Object.freeze([
    ...
    { key: "earnings_revenue_evidence", label: "Earnings and Revenue Evidence", weight: 0.08 },
    { key: "price_volume_leadership", label: "Price and Volume Leadership", weight: 0.08 },
    { key: "relative_strength", label: "Relative Strength", weight: 0.06 },
    { key: "liquidity_tradability", label: "Liquidity and Tradability", weight: 0.05 },
    { key: "risk_deterioration", label: "Risk and Deterioration Signals", weight: 0.05 },
    { key: "data_freshness_completeness", label: "Data Freshness and Completeness", weight: 0.04 },
  ]);
...
export function ratingTier(score: number): RatingTier {
  ...
  if (score === UNRESOLVED_GOLD_PLATINUM_BOUNDARY_SCORE) return "Tier Boundary Unresolved";
