...
| P0 | `live-status.html` | COMPLETE — PR #43 | Removed obsolete rollout, reserve-pool, pilot-target, invented-zero, and future-rating claims. The page now separates Official SEC Evidence, External Market Data · May Be Delayed, Demonstration Rating, Not Yet Rated, Unresolved SEC Identity, and Provider Not Connected; validates and reconciles API totals; preserves the last valid snapshot after later failures; prevents overlapping refreshes; and provides a direct TradingView fallback for blocked widgets. | Completed in commits `f4d40e2baef7b14c1494156ef64f60aa3863f1aa`, `806a1ee377a6cd2156ee80ec402a4cd6d572e24f`, and `55ceeda8cf5c8d0a8539ca8e430f660a88055729`. Page-local routes to Home, Start Here, Coverage, Monster Check™, and Factory Status were verified. GitHub Actions did not register a pull-request workflow run for the latest head when checked; no test failure was reported. PR #43 remains open and unmerged. |
